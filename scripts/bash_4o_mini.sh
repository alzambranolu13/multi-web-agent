...
python3 main.py --config generic --n_jobs 4 --backend 4o-mini --run_set test --relaunch --contains 2025-05-09_01-13-06_generic-on-webarena-test_generic_4o-mini
python3 main.py --config generic --n_jobs 4 --backend 4o-mini --run_set test --relaunch --contains 2025-05-09_15-15-50_generic-on-webarena-test_generic_4o-mini 
