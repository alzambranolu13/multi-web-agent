...
python3 main.py --config CPFixed --n_jobs 2 --reproduce --strategy strategy_1 --prompt_opt 3 --backend qwen --run_set hard --relaunch --contains 2025-05-16_12-01-28_cpfixed-controllercpfixed-qwen-qwen2-5-vl-72b-instruct-on-webarena-test_strategy_1_v3
python3 main.py --config CPFixed --n_jobs 2 --reproduce --strategy strategy_1 --prompt_opt 3 --backend qwen --run_set hard 
python3 main.py --config CPFixed --n_jobs 2 --reproduce --strategy strategy_1 --prompt_opt 3 --backend qwen --run_set hard 
python3 main.py --config CPFixed --n_jobs 2 --reproduce --strategy strategy_1 --prompt_opt 3 --backend qwen --run_set hard 
python3 main.py --config CPFixed --n_jobs 2 --reproduce --strategy strategy_1 --prompt_opt 3 --backend qwen --run_set hard 
