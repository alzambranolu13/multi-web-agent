...
python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_4 --prompt_opt 3 --backend 4o-mini --run_set valid --ignore_dependencies


2025-05-08_02-46-23_cpfixed-on-webarena_strategy_4_v3