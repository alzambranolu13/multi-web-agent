...
#python3 main.py --config generic --n_jobs 4 --backend 41-mini-plan --run_set hard --relaunch --contains 2025-05-19_13-16-40_generic-genericagent-gpt-4-1-mini-on-webarena-test_generic
#python3 main.py --config generic --n_jobs 4 --backend 41-mini-plan --run_set hard --relaunch --contains 2025-05-19_14-08-02_generic-genericagent-gpt-4-1-mini-on-webarena-test_generic
#python3 main.py --config generic --n_jobs 4 --backend 41-mini-plan --run_set hard --relaunch --contains 2025-05-19_14-15-12_generic-genericagent-gpt-4-1-mini-on-webarena-test_generic
python3 main.py --config generic --n_jobs 4 --backend 41-mini-plan --run_set hard --relaunch --contains 2025-05-19_14-20-36_generic-genericagent-gpt-4-1-mini-on-webarena-test_generic