...
export AGENTLAB_EXP_ROOT="/home/nlp/users/azambrano/agentlab_results/strategies-qwen/strategy_2/"
SUFFIX="az-1"
...
python3 main.py --config CPFixed --n_jobs 1 --reproduce --strategy strategy_2 --prompt_opt 5 --backend qwen --run_set hard 
python3 main.py --config CPFixed --n_jobs 1 --reproduce --strategy strategy_2 --prompt_opt 5 --backend qwen --run_set hard 
python3 main.py --config CPFixed --n_jobs 1 --reproduce --strategy strategy_2 --prompt_opt 5 --backend qwen --run_set hard 
python3 main.py --config CPFixed --n_jobs 1 --reproduce --strategy strategy_2 --prompt_opt 5 --backend qwen --run_set hard 
python3 main.py --config CPFixed --n_jobs 1 --reproduce --strategy strategy_2 --prompt_opt 5 --backend qwen --run_set hard 
