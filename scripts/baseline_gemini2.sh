...
python3 main.py --config generic --n_jobs 4 --backend gemini  --run_set test --relaunch --contains 2025-12-17_11-03-29_generic-genericagent-google-gemini-2-5-flash-on-webarena-test_generic 
