...
export AGENTLAB_EXP_ROOT="/home/nlp/users/azambrano/agentlab_results/strategies-41/"
...
#python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_1 --prompt_opt 3 --backend 41 --run_set hard 
#python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_1 --prompt_opt 3 --backend 41 --run_set hard 
#python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_1 --prompt_opt 3 --backend 41 --run_set hard 
#python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_1 --prompt_opt 3 --backend 41 --run_set hard 
#python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_1 --prompt_opt 3 --backend 41 --run_set hard 
#python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_3 --prompt_opt 3 --backend 41 --run_set hard 
#python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_3 --prompt_opt 3 --backend 41 --run_set hard 
#python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_3 --prompt_opt 3 --backend 41 --run_set hard 
#python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_3 --prompt_opt 3 --backend 41 --run_set hard 
#python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_3 --prompt_opt 3 --backend 41 --run_set hard 
python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_4 --prompt_opt 3 --backend 41 --run_set hard --relaunch --contains 2025-05-18_01-02-14_cpfixed-controllercpfixed-gpt-4-1-mini-on-webarena-test_strategy_4_v3 
python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_4 --prompt_opt 3 --backend 41 --run_set hard 
python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_4 --prompt_opt 3 --backend 41 --run_set hard 
python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_4 --prompt_opt 3 --backend 41 --run_set hard 
python3 main.py --config CPFixed --n_jobs 4 --reproduce --strategy strategy_4 --prompt_opt 3 --backend 41 --run_set hard 
